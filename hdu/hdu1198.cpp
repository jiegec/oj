...
void dfs(int x, int y) {
  ...
  if (states[x][y]->up) {
    ...
    if (tempx >= 1 && tempx <= m && tempy >= 1 && tempy <= n &&
        !used[tempx][tempy] && states[tempx][tempy]->down) {
      dfs(tempx, tempy);
    }
  }
  if (states[x][y]->right) {
    ...
    int tempy = y + 1;
    if (tempx >= 1 && tempx <= m && tempy >= 1 && tempy <= n &&
        !used[tempx][tempy] && states[tempx][tempy]->left) {
      dfs(tempx, tempy);
    }
  }
  if (states[x][y]->down) {
    ...
    int tempy = y;
    if (tempx >= 1 && tempx <= m && tempy >= 1 && tempy <= n &&
        !used[tempx][tempy] && states[tempx][tempy]->up) {
      dfs(tempx, tempy);
    }
  }
  if (states[x][y]->left) {
    ...
    int tempy = y - 1;
    if (tempx >= 1 && tempx <= m && tempy >= 1 && tempy <= n &&
        !used[tempx][tempy] && states[tempx][tempy]->right) {
      dfs(tempx, tempy);
    }
  }
}
